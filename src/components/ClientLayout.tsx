    ...
    <>
      ...
      <div className="min-h-screen flex flex-col bg-bg">
        ...
        <footer className="mt-auto border-t border-line bg-surface-sunk">
          <div className="max-w-[1440px] mx-auto px-6 h-11 flex items-center justify-between gap-3 select-none">
            <span className="text-xs text-fg-muted">Made with <span aria-hidden="true">❤</span> by Xingrui Zhou</span>
